...
//    public List<Eurocarb> eurocarb;
    ...
    //public static List<GlycobaseSource> findGlycobaseTaxonomy(String search) {
	...
	return output; //listSql;
    }

    //public static List<GlycobaseSource> findGlycobaseTissue(String search) {
