...
// @LINE:29
val controllers_Application_taxonsearch11 = Route("GET", PathPattern(List(StaticPart("/taxonomysearch"))))
...
// @LINE:29
case controllers_Application_taxonsearch11(params) => {
